...
$cat_id ="";
$cat_name = "";
$select_sql = "select * from category where cat_id =$_GET[cid]";
...
if(isset($_POST['update'])){
    ...
    $con = mysqli_connect("localhost", "root", "", "lms");
    print_r($_GET);
    $update ="UPDATE `category` SET `cat_name`='$_POST[cat_name]' WHERE cat_id = $_GET[cid]";
    print_r($update); 
    //$update = "update catrgory set cat_name='$_POST[cat_name]' where cat_id = $_GET[cid]";
