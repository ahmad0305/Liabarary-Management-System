        ...
        <div class="col-md-4">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="book_no" placeholder="Enter Book Number" class="form-control" required="">
                </div>
                <div class="form-group">
                    <label for="">Student ID:</label>
                    <input type="text" name="student_id" placeholder="Enter Stuedent id" class="form-control" required="">
                </div>
                <div class="form-group">
