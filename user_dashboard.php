<?php
session_start();
function getUserBookCount(){
  $con = mysqli_connect("localhost", "root", "", "lms");
  $user_issued_book_count ="";
  $user_count = "select count(*) as user_issued_book_count from issued_books where student_id=$_SESSION[id]";
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="row">
        <div class="col-md-3"><div class="card bg-light" style="width:300px">
            ...
            <div class="card-body">
              <p class="card-text">No. of Issued Books: <?php echo getUserBookCount(); ?></p>
              <a href="view_issed_book.php" class="btn btn-danger" target="_blank">View Issued Books</a>
            </div></div>
